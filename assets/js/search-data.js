...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Here is a collection of some projects I&#39;ve worked",
          section: "Navigation",
          handler: () => {
          ...
          title: "repositories",
          description: "The following are projects I have worked on that are currently public on GitHub",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-vector-database-analysis-vdba",
          ...
          title: 'OS Sim',
          description: "a C++ program that simulates an operating system",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://discord.com/users/codying", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%75%6D%61%72%68%75%6E%74%65%72@%70%72%6F%74%6F%6E.%6D%65", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/umarhunter", "_blank");
        },
      },{
      id: 'light-theme',
